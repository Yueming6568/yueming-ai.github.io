...
**Visual tone**: Clean, airy minimalist with a refined purple accent system inspired by Nanjing University's identity. Not monotone black-and-white — use purple tones to bring warmth, identity, and sophistication to key moments (like Codex.ai uses warm terracotta/coral touches). Generous whitespace, inspired by Codex.ai's breathing room and MMLab's information density balance.
